...
@Component({
  selector: 'app-snqcompleted',
  templateUrl: './snqcompleted.component.html',
  styleUrls: ['./snqcompleted.component.scss']
})
export class SnqcompletedComponent implements OnInit {
  ...
  setGroupFliter(request) {
    this.loaderService.startLoading();
    this.snq.snqcompletedtaskEnquiryList(this.request)
      .pipe()
      .subscribe(
        data => {
          this.loaderService.stopLoading();
